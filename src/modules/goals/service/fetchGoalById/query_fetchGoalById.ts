...
// export const query_fetchGoalById = async (goal_id: string): Promise<IGoalSchema | null> => {
//     const client = await generateTSClient()
//     const selectedGoal = selectedGoalAtom$.get(selectedGoalAtom)

//     if (selectedGoal?.is_new)
//         return optimizeActiveGoalsData(newGoalTemplate(selectedGoal.id, selectedGoal.parent_goal_id) as IGoalSchema)[0]
...
//                 })
//                 .then((res) => {
//                     return optimizeActiveGoalsData(res.goals_by_pk as IGoalSchema)?.[0] || null
//                 }),
//         (e) => {
