...
export const LoginLogo: React.FC = observer(() => {
    return (
        <div className='relative m-auto my-5 flex select-none items-center justify-center font-cinzel text-[100px] '>
...
export const LoginLogoSm: React.FC = observer(() => {
    return (
        <div className='absolute left-14 top-7 flex select-none items-center justify-center font-cinzel text-[30px] '>
