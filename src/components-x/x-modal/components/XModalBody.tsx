...
export const XModalBody: React.FC<IXModal> = ({ closeIcon = true, onCancel, children, title }) => {
    return (
        <div className='h-full w-full flex items-center justify-center'>
            <div
                className='x-modal-body bg-global-2-bg-plasma  flex-col relative flex w-full 
            ...
            >
                ...
                <div className='overflow-scroll py-4 scrollbar-thumb-blue-600 scrollbar-track-transparent scrollbar-thin'>
                    <div className='max-w-[350px] mx-auto w-full flex flex-col'>
                        ...
                        <div className='flex mx-auto h-full w-full flex-col mb-5'>{children}</div>
                    </div>
                </div>
            </div>
        </div>
