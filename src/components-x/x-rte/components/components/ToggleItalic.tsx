...
export const ToggleItalic: React.FC<{
    ...
    return (
        <button
            ...
            onClick={() => toggleInlineStyle({ style: toolbarItems.ITALIC, editorState, editorRef, setEditorState })}
        >
            <IconItalic
                className={cn(
                    'cursor-pointer hover:text-blue-500 mt-[2px] h-5 w-5',
                    isToolBarItemActive(editorState, toolbarItems.ITALIC) && 'text-blue-500',
                )}
            />
        </button>
    )
